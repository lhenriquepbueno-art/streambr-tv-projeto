...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull View divider,
      @NonNull ProgressBar progressLoading, @NonNull TextView tvLogo, @NonNull TextView tvTagline,
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, divider, progressLoading,
          tvLogo, tvTagline, tvVersion);
    }
